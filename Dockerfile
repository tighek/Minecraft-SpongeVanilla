...
ADD https://repo.spongepowered.org/maven/org/spongepowered/spongevanilla/1.12.2-7.1.0-BETA-21/spongevanilla-1.12.2-7.1.0-BETA-21.jar /srv/spongevanilla.jar
RUN ln -s /srv/spongevanilla.jar /srv/minecraft/spongevanilla.jar

RUN touch /srv/spongevanilla_1.12.2-7.1.0-BETA-21
